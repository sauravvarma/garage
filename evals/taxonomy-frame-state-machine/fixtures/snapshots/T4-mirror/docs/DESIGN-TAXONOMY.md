...
|----------|----------|-------|------------|-------|
| [anchor] Habit Tracker — Warm Ember (direction) | `W0LQhY` | anchor | — | Direction anchor (winner of `[explore]` 2026-05-20); wrote DESIGN-HEURISTICS. Reference role only — never implemented. |
| [final] Habit Tracker — B: Single-column card stack | `K8IFwN` | final | Synced | Implementable spec for `/habits`; winner of `[proposal]` 2026-05-25. Code matches. |
| [deprecated] Habit Tracker — A: Cool Grid | `CTYCB` | deprecated | — | Lost direction decision 2026-05-20. |
| [deprecated] Habit Tracker — C: Mono Ledger | `lc1zQ` | deprecated | — | Lost direction decision 2026-05-20. |
| [deprecated] Habit Tracker — A: Two-pane split | `v5dPLg` | deprecated | — | Lost composition decision 2026-05-25. |
| [deprecated] Habit Tracker — C: Compact rows | `MlSIh` | deprecated | — | Lost composition decision 2026-05-25. |
| [anchor] Habits Route (shipped) — Default state | `FRqFf` | anchor | — | Mirror baseline (`[mirror]` captured 2026-06-10 from shipped `/habits`). 1:1 grounding for the redesign; staleness, not sync, is its failure mode. |
| [anchor] Habits Route (shipped) — Empty state | `f9VLUJ` | anchor | — | Mirror baseline (`[mirror]` captured 2026-06-10). Empty state of shipped `/habits`. |
