...
|----------|----------|-------|------------|-------|
| [anchor] Habit Tracker — Warm Ember (direction) | `PmeTu` | anchor | — | Direction anchor (winner of `[explore]` 2026-05-20); wrote DESIGN-HEURISTICS. Reference role only — never implemented. |
| [final] Habit Tracker — B: Single-column card stack | `C87F8` | final | Synced | Implementable spec for `/habits`; winner of `[proposal]` 2026-05-25. Code matches. |
| [deprecated] Habit Tracker — A: Cool Grid | `k2GfsE` | deprecated | — | Lost direction decision 2026-05-20. |
| [deprecated] Habit Tracker — C: Mono Ledger | `WueHx` | deprecated | — | Lost direction decision 2026-05-20. |
| [final] Habit Tracker — A: Two-pane split | `RBqcO` | final | Not started | Promoted 2026-06-01 to replace the card-stack layout. |
| [deprecated] Habit Tracker — C: Compact rows | `S7Qmm8` | deprecated | — | Lost composition decision 2026-05-25. |
