...
|----------|----------|-------|------------|-------|
| [anchor] Habit Tracker — Warm Ember (direction) | `q6rVI` | anchor | — | Direction anchor (winner of `[explore]` 2026-05-20); wrote DESIGN-HEURISTICS. Reference role only — never implemented. |
| [deprecated] Habit Tracker — A: Cool Grid | `q2OgS9` | deprecated | — | Lost direction decision 2026-05-20. |
| [deprecated] Habit Tracker — C: Mono Ledger | `zw5ca` | deprecated | — | Lost direction decision 2026-05-20. |
| [variant] Habit Tracker — A: Two-pane split | `DCKPe` | variant | — | Composition candidate in `[proposal]` 2026-05-25 (open). |
| [variant] Habit Tracker — B: Single-column card stack | `Otu6L` | variant | — | Composition candidate in `[proposal]` 2026-05-25 (open). |
| [variant] Habit Tracker — C: Compact rows | `YemjA` | variant | — | Composition candidate in `[proposal]` 2026-05-25 (open). |
