...
|----------|----------|-------|------------|-------|
| [concept] Habit Tracker — A: Cool Grid | `jKu7M` | concept | — | Direction candidate in `[explore]` 2026-05-20 (open). |
| [concept] Habit Tracker — B: Warm Ember | `VaLCk` | concept | — | Direction candidate in `[explore]` 2026-05-20 (open). |
| [concept] Habit Tracker — C: Mono Ledger | `bZD0k` | concept | — | Direction candidate in `[explore]` 2026-05-20 (open). |
